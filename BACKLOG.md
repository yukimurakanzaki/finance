...
**Status as of 2026-07-31.** This is a ready-to-execute ticket list distilled from
`PAIN-POINTS.md` (the analysis), the project's build history so far, and — for
§D — a later round of elicitation that surfaced a pain point PAIN-POINTS.md
never covered. Use this
...
| Ledger Control | Correct a balance without logging a transaction + full CRUD on accounts/assets, income, recurring, allowance | 📋 Requirements written 2026-07-31, **not yet built** | **This document, §D** + `docs/plans/2026-07-31-ledger-control-requirements.md` |
...
§D goes after §B1/§B4 specifically — see the collision warning at the end of §D.
